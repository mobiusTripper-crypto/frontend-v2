<template>
  <div class="absolute right-4 top-4 float-right flex flex-col items-end">
    <div v-if="tvl > 0" class="text-green-500 font-semibold">
      TVL: ${{ fNum(tvl, 'usd_lg') }}
    </div>
    <div v-if="beetsPrice > 0" class="text-red-500 font-semibold ">
